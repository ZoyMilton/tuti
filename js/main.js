(function () {
    ...
    // --- [FUNCIONAES DE MANIPULACION DE AUDIO] ----------------------------
    ...
    const getDataFromStreamAfrica = async (artist, title, defaultArt, defaultCover) => {
        ...
        // Modificacion para acceder al objeto "resultados" de la respuesta de API
        ...
        const results = {
          //title: stream.title || title, // Utilizando los datos de la nueva respuesta de la API
    ...
    // --- [FUNCIONES DE MANIPULACION DEL INTERFACE] ------------------------
    ...
    // --- [ACTUALIZA ELEMENTOS DE LA PÁGINA DE LA ESTACION] ------------------
    ...
    // --- [FUNCIONES DE ACTUALIZACION DE CONTENIDO] ----------------------- 
